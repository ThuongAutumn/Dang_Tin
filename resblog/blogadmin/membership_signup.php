<?php
	...
	if($_POST['signUp'] != ''){
		...
		// thông báo quản trị
		/* ---- tên ứng dụng như được cung cấp trong AppGini được sử dụng ở đây ---- */
		$message = nl2br(
	...
	// danh sách thả xuống của các nhóm cho phép tự đăng ký
...
<?php if(!$noSignup){ ?>
	<div class="d-flex row">
		<div class="d-none col-sm-12 col-md-6 col-lg-8" id="signup_splash">
			<!-- nội dung tùy chỉnh -->
		</div>
	...
	<script>
		$j(function() {
			...
			/* phản hồi về độ mạnh của mật khẩu*/
		...
		var uaro; // đối tượng yêu cầu tính khả dụng của người dùng
		function checkUser(){
