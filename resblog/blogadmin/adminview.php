              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Chi tiết web</strong></p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Đường dẫn</strong></p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Lựa chọn của người biên tập</strong></p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Quản trị nhân viên</strong></p>
                  </div>
                </div>
              </div>
              <a href="../adminstats">
