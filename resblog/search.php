...
<html lang="zxx">
<head>
	<title>Tìm kiếm|<?php getwebname("titles"); echo"|"; gettagline("titles");?></title>
...
<body>
	...
	<section class="main-content-w3layouts-agileits">
		...
		# code...
    						...
    						echo "<p style=color:#4FC1E9><b>thông tin tìm kiếm cho bạn:<u style=color:black> $search_keyword</u></b></p>";
					...
					<div class="row">
						...
						<div class="col-lg-4 card">
							...
							<div class="card-body">
								...
								<a href="single.php?id=<?php echo $row['id']; ?>" class="btn btn-primary read-m">Xem chi tiết</a>
							</div>
						</div>
						<?php
                                  }
